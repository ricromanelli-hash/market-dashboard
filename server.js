...
const CAMPOS_KPI = [
  ...
  // balanço (aba Balanço Resumido). `total_passivo` já inclui o PL: PC + PNC + PL fecha
  // com o total do ativo, conferido na EGIE3 em 2024 e 2025.
  ['totalAtivo', 'total_ativo', milhoes],
  ['ativoCirc', 'total_ativocirculante', milhoes],
  ['ativoNaoCirc', 'total_ativonaocirculante', milhoes],
  ['aplicacoes', 'aplicacoes', milhoes],
  ['contasReceber', 'contasareceber', milhoes],
  ['estoque', 'estoque', milhoes],
  ['investimentos', 'investimentos', milhoes],
  ['imobilizado', 'imobilizado', milhoes],
  ['intangivel', 'intangivel', milhoes],
  ['outrosAnc', 'outros_anc', milhoes],
  ['totalPassivo', 'total_passivo', milhoes],
  ['passivoCirc', 'total_passivocirculante', milhoes],
  ['passivoNaoCirc', 'total_passivonaocirculante', milhoes],
  ['fornecedores', 'fornecedores', milhoes],
  ['dividaCurto', 'divida_cp', milhoes],
  ['dividaLongo', 'divida_lp', milhoes],
  ['reservaLucros', 'reservadelucros', milhoes],
  ['tesouraria', 'acoes_em_tesouraria', milhoes],
  ['cgol', 'cgol', milhoes],
  // valuation e retorno (aba de indicadores fundamentalistas)
  ['lpa', 'lpa', decimal],
  ['ppa', 'ppa', decimal],
  ['precoLucro', 'preco_lucro', decimal],
  ['vpa', 'vpa', decimal],
  ['pvpa', 'pvpa', decimal],
  ['evEbitda', 'ev_ebtda', decimal],
  ['evEbit', 'ev_ebit', decimal],
  ['roa', 'roa', pct],
  ['cagrReceitas', 'cagr_receitas_5a', pct],
  ['cagrLucros', 'cagr_lucros_5a', pct],
  ['cagrDividendos', 'cagr_dividendos_5a', pct],
  ['rta1a', 'rta_1y', pct],
  ['rta3a', 'rta_3y', pct],
  ['rta5a', 'rta_5y', pct],
  // mercado
